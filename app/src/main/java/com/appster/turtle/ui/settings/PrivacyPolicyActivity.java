...
public class PrivacyPolicyActivity extends BaseActivity {
    ...
    private void initUI() {
        setUpHeader(mBinding.header.clHeader, getString(R.string.privacy_policy_caps));
        ...
        String url = BuildConfig.BASE_URL_PRIVACY + Constants.URLS.PRIVACY;
