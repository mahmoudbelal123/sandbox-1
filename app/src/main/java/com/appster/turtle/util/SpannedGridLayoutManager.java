...
/*
  ...
  Created by navdeepbedi on 14/12/17.
 */
...
public class SpannedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static class SpanInfo {
        public int columnSpan; //NOSONAR
        public int rowSpan;//NOSONAR
    ...
    private void calculateWindowSize() {
        ...
        int cellWidth =
                (int) Math.floor((getWidth() - getPaddingLeft() - getPaddingRight()) / (double) columns);
